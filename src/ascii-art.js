...
export const ASCII_ART = {
  ...
  banner: `
${chalk.magenta('    ╔══════════════════════════════════════════════════════════════╗')}
${chalk.magenta('    ║')}  ${chalk.red('╔═══╗')}  ${chalk.green('╔═══╗')}  ${chalk.yellow('╔═══╗')}  ${chalk.blue('╔═══╗')}  ${chalk.magenta('╔═══╗')}  ${chalk.cyan('╔═══╗')}  ${chalk.red('╔═══╗')}  ${chalk.magenta('║')}
${chalk.magenta('    ║')}  ${chalk.red('║')} ${chalk.white.bold('A')} ${chalk.red('║')}  ${chalk.green('║')} ${chalk.white.bold('I')} ${chalk.green('║')}  ${chalk.yellow('║')} ${chalk.white.bold('-')} ${chalk.yellow('║')}  ${chalk.blue('║')} ${chalk.white.bold('S')} ${chalk.blue('║')}  ${chalk.magenta('║')} ${chalk.white.bold('H')} ${chalk.magenta('║')}  ${chalk.cyan('║')} ${chalk.white.bold('E')} ${chalk.cyan('║')}  ${chalk.red('║')} ${chalk.white.bold('L')} ${chalk.red('║')}  ${chalk.magenta('║')}
${chalk.magenta('    ║')}  ${chalk.red('╚═══╝')}  ${chalk.green('╚═══╝')}  ${chalk.yellow('╚═══╝')}  ${chalk.blue('╚═══╝')}  ${chalk.magenta('╚═══╝')}  ${chalk.cyan('╚═══╝')}  ${chalk.red('╚═══╝')}  ${chalk.magenta('║')}
${chalk.magenta('    ╚══════════════════════════════════════════════════════════════╝')}
